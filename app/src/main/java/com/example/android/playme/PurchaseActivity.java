 ...
 */
public class PurchaseActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backToLibrary.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View view){
                Intent backToLibraryIntent = new Intent(PurchaseActivity.this, MainActivity.class);
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(PurchaseActivity.this,
